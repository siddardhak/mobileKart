				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<p> 4.2' Screen, snap-dragon processor, 1GB RAM, 4GB Internal memory,<br> Rs 5000.</p>
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<p> 4' Screen, snap-dragon processor, Android 3.2, 1GB RAM, 4GB Internal memory,<br> Rs 4000.</p>
							<a href="#myModal" role="button" data-toggle="modal" class="btn btn-primary btn-block">Order Now!</a>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<center><img src="images/htc/htc5.png" alt="Item" height="180px" width="180px"/></center>
...
<div class="pagination">
  <a href="#">&laquo;</a>
  <a class="active" href="htc.php">1</a>

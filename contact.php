				...
				<div class="container">
					<div class="col-lg-8" style="margin-bottom:10px;">
						...
						<form role="form" action="contact_script.php" method="POST">
							...
							<div class="form-group">
								<label>Message:</label>
								<textarea class="form-control" rows="5" name="message" required = "true" placeholder="give name of the mobile in one paragraph and in the next specify the problem"></textarea>
							</div>
